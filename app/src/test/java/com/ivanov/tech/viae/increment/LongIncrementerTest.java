...
public class LongIncrementerTest {

    private LongIncrementer incrementer;

    @Before
    public void createIncrementer() {
        incrementer = new LongIncrementer();
    }

    /**
     * @see LongIncrementer#getNumber()
    ...
    public void getNumber_isZeroInitially() {
        ...
        long initialValue = incrementer.getNumber();

        assertEquals(0, initialValue);
    }

    /**
     * @see LongIncrementer#incrementNumber()
    ...
    public void incrementNumber_increasesByOne() {
        for (long i = 0; i < 5; i++) {
            ...
            long incremented_value = incrementer.getNumber();

            assertEquals(incremented_value, initialValue + 1);
        }

        long value = incrementer.getNumber();
        assertEquals(5, value);
    }

    /**
     * @see LongIncrementer#setMaximumValue(Long)
    ...
    public void setMaximumValue_resetsWhenReachMaxValue() {
        incrementer.setMaximumValue(5L);
    ...
    public void setMaximumValue_isTypesMaxValueByDefault() {
        ...
        long value = new LongIncrementer(){
            public long getMaximum() {
                return maxValue;
            }
        }.getMaximum();

        assertEquals("maxValue by defalt is Long.MAX_VALUE", Long.MAX_VALUE, value);
    }
